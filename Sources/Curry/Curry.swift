...
func curry<A, B, C, D>(_ ternaryFunc: @escaping (A, B, C) -> D )
->
(A) -> ((B, C) -> D) {
...
func ^^ <A, B, C, D>(ternaryFunc: @escaping (A, B, C) -> D, arg: A)
->
(B, C) -> D {
...
func ^^ <A, B, C, D>(ternaryFunc: @escaping (A, B, C) -> D, args: (A, B, C))
->
() -> D {
...
func curry<A, B, C>(_ binaryFunc: @escaping (A, B) -> C )
->
(A) -> ((B) -> C) {
...
func ^^ <A, B, C>(binaryFunc: @escaping (A, B) -> C, arg: A)
->
(B) -> C {
...
func ^^ <A, B, C>(binaryFunc: @escaping (A, B) -> C, args: (A, B))
->
() -> C {
...
func curry<A, B>(_ unaryFunc: @escaping (A) -> B )
->
(A) -> (() -> B) {
...
func ^^ <A, B>(_ unaryFunc: @escaping (A) -> B, arg: A)
->
() -> B {
